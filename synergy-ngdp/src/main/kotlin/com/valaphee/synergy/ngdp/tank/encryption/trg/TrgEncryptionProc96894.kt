...
package com.valaphee.synergy.ngdp.tank.encryption.trg

import com.valaphee.synergy.ngdp.tank.TankResourceGraph
 ...
 * @author Kevin Ludwig
 */
object TrgEncryptionProc96894 : EncryptionProc<TankResourceGraph.Header> {
    override fun getKey(header: TankResourceGraph.Header, length: Int): ByteArray {
    ...
    override fun getIv(header: TankResourceGraph.Header, name: String, length: Int): ByteArray {
