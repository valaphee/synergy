...
class BnetProxy(
    ...
    companion object {
        ...
        internal val services = listOf(
            ...
            bgs.protocol.voice.v2.client.VoiceService::class,
            bgs.protocol.whisper.v1.WhisperService::class,
            bnet.protocol.connection.v1.ConnectionService::class,
            bnet.protocol.friends.v1.FriendsListener::class,
            bnet.protocol.friends.v1.FriendsService::class,
            bnet.protocol.game_utilities.v1.GameUtilitiesService::class,
