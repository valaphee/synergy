rem "C:\Program Files\Java\graalvm-ce-java17-22.0.0.2\bin\java.exe" -jar .\tool\protod.jar -i "C:\\Program Files (x86)\\Battle.net\\Battle.net.13401\\battle.net.dll" -o src\main\proto
